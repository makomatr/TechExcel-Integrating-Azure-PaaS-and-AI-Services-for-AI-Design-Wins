...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
        [Description("Get all bookings for a hotel with a specified date")]
         public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The DATE pf the hotel booking")] DateTime dt)
        {
    ...
    [KernelFunction]
        [Description("Get all bookings without an associate room.")]
    ...
    [KernelFunction]
        [Description("Get all bookings that have multiple rooms.")]
